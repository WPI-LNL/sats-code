...
class decoder:
    ...
    def __init__(self, pi, gpio_0, gpio_1, callback, user_callback, bit_timeout=10):
        ...
        if level < pigpio.TIMEOUT:
            ...
            if self.in_code:
                ...
                if self.code_timeout == 3: # both gpios timed out
                    ...
                    self.in_code = False
                    self.callback(self.bits, self.num, self.user_callback)
...
if __name__ == "__main__":
    ...
    w = wiegand.decoder(pi, 15, 18, callback)
...
async def run_with_callback(callback_func):
    import time
    import pigpio
    import wiegand
